codeunit 50005 "Quality Management"
{
    ...
    begin
        WITH InspectionDS DO BEGIN
            ...
            ELSE BEGIN
                ...
                //tempInspectionReceipt.Status := tempInspectionReceipt.Status::"Under Test";  //PCPL-25/060223
    ...
    begin
        WITH InspectionRS DO BEGIN
            ...
            //insertPostedInspection.Status := insertPostedInspection.Status::Release;  //PCPL-25/060223
            CALCFIELDS("File Attach");
