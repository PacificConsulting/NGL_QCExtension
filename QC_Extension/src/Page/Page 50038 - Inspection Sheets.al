    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Replanned Item No."; "Replanned Item No.")
                {
                    ApplicationArea = all;
                }
            }
